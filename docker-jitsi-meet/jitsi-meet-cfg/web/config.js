...
config.hosts.domain = 'thexxx.club';
config.focusUserJid = 'focus@auth.thexxx.club';

config.hosts.muc = 'muc.thexxx.club';
config.bosh = '/http-bind';
config.websocket = 'wss://thexxx.club/xmpp-websocket';
// Video configuration.
//
