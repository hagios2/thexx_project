...
return [
    ...
    "initial_text" => [
        "This Privacy & Cookies Policy (the \"Policy\") dated April 26, 2021 replaces all previous policies. Please take the time to review before you continue to use our products and services.",
    ...
    "items" => [
        [
            ...
            "items" => [
                "type" => "text",
                "content" => [
                    config("other.company_name") . " operates the software platform located on The XXX Club (the \"Platform\").",
                ],
            ]
        ],
        [
            ...
            "items" => [
                "type" => "ul",
                "content" => [
                    "Information you provide to us, including by way of example only, your username, email address, and date of birth",
                    "Your IP address",
                    ...
                    "Information about your interaction with the Platform including any advertisements",
                    "Information we collect using cookies stored on your device about your use of the Platform and/or selected third party websites.",
        ...
        [
            "title" => "How we may use your information in specific products or services Registration",
            "items" => [
                "type" => "text",
                "content" => [
                ...
                "content" => [
                    ...
                    [
                        ...
                        "content" => [
                            ...
                            "Cookies used to improve your browsing experience. These cookies allow the website to remember choices you make, such as your language or region and they provide improved features such as content provider recommendations and limiting the number of times a particular advertisement is shown to you.",
                            "Cookies used to understand how people use our products and services. This allows us to keep track of what pages are popular to help other users find such pages.",
        ...
        [
            ...
            "items" => [
                "type" => "text",
                "content" => [
                    "If you wish to review or receive a copy of the personal information we hold about you, or If you have any queries or comments about this Privacy & Cookies Policy OR if you wish to review or receive a copy of the personal information we hold about you, please write to us at:",
                    "Attention: Data Protection Officer<br>" .
                    config("other.company_name") . "<br>" .
                    "18 Ratchadapisek Road<br>" .
                    "Bangkok 10110<br>" .
                    "Thailand<br>" .
                    "privacy@thexxx.club<br>",
                    "",
                ...
                "content" => [
                    ...
                    [
                        ...
                        "content"=> [
                            ...
                            "The categories of sources of the information we have collected about you;",
                            "The purpose for which we have collected such information about you;",
                            "A copy of the personally identifying information we have collected about you; and,",
                            "To be informed if we have sold or disclosed your personally identifying information to a third party and for what purpose."
                        ]
                    ],
                    "In order to obtain a copy of this information with respect to your account, you may email Email address: support@thexxx.club",
                    "For your privacy and protection, we will require certain information to confirm that it is you, the accountholder, requesting the information. If there is no information associated with your account that we can verify, such as your email address or other information, we may be unable to complete your request. For your protection, responsive information will only be delivered to the email address assigned to the subject account. For an email address to be \"assigned to an account\" as used herein, it means the email address to which you receive account security notifications such as account recovery instructions; it does not mean the email address you may have provided in completing your Independent Broadcaster Agreement, if you completed an Independent Broadcaster Agreement."
                ],
            ]
        ],
    ]
