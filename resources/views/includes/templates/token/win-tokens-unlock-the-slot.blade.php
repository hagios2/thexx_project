        ...
        <main id="design-theme" class="theme-accounts theme-wallet-vip-tokens">
            ...
            <header id="theme-accounts">
                <header>
                    ...
                    <h2 class="win-tokens-sub-heading">
                        Bet 1 token and ride the slot! <span class="highlighted-text">Get three identical figures and win 500 tokens!</span>
                    </h2>
                </header>
            ...
            <div id="wrapper-win-tokens">
                <div id="weekly-lottery">
                    "Unlock the slot" Widget here!
                </div>
            </div>
